    ...
    <>
      ...
      <div className="flex ml-8 my-4">
        <input
          ...
          className="h-[3rem] rounded-2xl w-[18rem] bg-gray-200 outline-none px-4"
        />
      </div>
                ...
                return (
                  <tr className="border-b-2">
                    <td className="flex items-center px-6 py-4">
                      ...
                      />
                      <div className="mx-10 font-bold text-xl">{movieObj.title}</div>
                    </td>
                    ...
                    <td  className="text-red-800 bg">
                        <button onClick={()=>handleRemoveFromWatchlist(movieObj)} className="bg-slate-600 px-4 py-2 text-white rounded-3xl">Delete</button>
                    </td>
                  </tr>
                );
              })}
